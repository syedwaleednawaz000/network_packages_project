...
class PackageDetailsScreen extends StatefulWidget {
  int? selectIndex;
  String? name ;
  PackageDetailsScreen({Key? key, required this.name,required this.selectIndex,required this.image}) : super(key: key);
            ...
            FutureBuilder(
                ...
                builder: (context,AsyncSnapshot? snapshot) {
                  ...
                  if (myData == null) {
                    ...
                    return Expanded(
                      child: controller.text.isNotEmpty ? ListView.builder(
                        ...
                        return myData[index]['package_name'].toString().toLowerCase().contains(controller.text.toString().toLowerCase()) ? Container(
                          // height: 150.h,
                        ...
                        ): dataMatch == false ? index == 0 ? Text("Data Not found",style: TextStyle(color: Colors.white),):Text(""):Text("");
                      }): ListView.builder(
                          itemCount: myData.length,
                          // shrinkWrap: true,
                          // physics: const NeverScrollableScrollPhysics(),
